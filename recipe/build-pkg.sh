...
# fix dials related repositories
rm -fr ./modules/dials
rm -fr ./modules/dxtbx
rm -fr ./modules/xia2
cd modules
git clone -b v3.29.0 https://github.com/cctbx/dxtbx.git
git clone -b v3.29.0 https://github.com/dials/dials.git
git clone -b v3.29.0 https://github.com/xia2/xia2.git
cd ..

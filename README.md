...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-chem_data-green.svg)](https://anaconda.org/conda-forge/chem_data) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/chem_data.svg)](https://anaconda.org/conda-forge/chem_data) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/chem_data.svg)](https://anaconda.org/conda-forge/chem_data) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/chem_data.svg)](https://anaconda.org/conda-forge/chem_data) |

Installing chem_data
====================

Installing `chem_data` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `chem_data` can be installed with `conda`:
...
```
conda search chem_data --channel conda-forge
```

or with `mamba`:

```
mamba search chem_data --channel conda-forge
```
...
mamba repoquery search chem_data --channel conda-forge

# List packages depending on `chem_data`:
mamba repoquery whoneeds chem_data --channel conda-forge

# List dependencies of `chem_data`:
mamba repoquery depends chem_data --channel conda-forge
```
